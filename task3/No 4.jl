...
# ╔═╡ 94e28964-5c95-11ed-3342-7f620273b5fc
begin
	using NPZ
	using LinearAlgebra
	using Images
...
# ╔═╡ d772e1b1-0c00-4159-ac46-84478bb7cb87
md"### Загрузка данных"

# ╔═╡ 90d26578-ec7a-4a77-af9a-3636b0422465
begin
...
# ╔═╡ 4006badd-51f7-4b9b-9f28-b329b2d1af3a
md"Построим изображение после свёртки:"

# ╔═╡ 0660c3b4-017e-49d3-8ef0-2320c4bfc9dc
plot(Gray.(A ./ maximum(A)))

# ╔═╡ 0e87b696-6f11-4a46-9511-b95fd6124e70
md"Определим функции, разворачивающие матрицу в вектор и обратно:"

# ╔═╡ ef0f83ce-ee0c-4ca4-9f79-51a901ba9285
function mat2vec(A)
	A = @view A[end:-1:begin, :]
	return vec(copy(A'))
end

# ╔═╡ 18d4e260-71bc-455f-a6f4-b4284409b2a2
function vec2mat(a, shape = (16, 51))
	A = reshape(a, reverse(shape))'
	return A[end:-1:begin, :]
end

# ╔═╡ cd610ce4-6210-4daf-bb42-abb71ee05cbd
a = mat2vec(A)

# ╔═╡ 43e78e0b-c9f9-4fe6-9bcb-b47414e0e757
md"### Тест работы фильтра"

# ╔═╡ 4ecf001e-9c26-4b2f-80b5-950c41bd2c3b
md"Чтобы понять, как работает фильтр, создадим тестовое изображение и посмотрим, как оно выглядит после свёртки:"

# ╔═╡ 6f810a69-a232-4b9e-9697-6a628233d9ad
begin
	B = zeros(16, 51)
	B[8, :]  .= 1
	B[:, 25] .= 1
...
# ╔═╡ 65f431bf-4ef5-49d0-ba8b-28145120c902
plot_vec(C * b, (25, 60), title = "Тестовое изображение после свёртки", topmargin = 20Plots.px)

# ╔═╡ b7937869-d42b-4090-a72c-21aa9a70e852
md"### Обращение фильтра"

# ╔═╡ 4b6f7f0b-5069-4fea-8e78-1ee8b0c1be13
C_SVD = svd(C)

# ╔═╡ d064e57c-e484-45cd-8e96-36f8ff18d016
plot_vec(C_SVD \ a, title = "Восстановленное изображение; все сингулярные числа", topmargin = 20Plots.px)

# ╔═╡ c79cee68-397b-4ac9-913b-bee91ffa84d4
...
# ╔═╡ d409c4c5-ff8b-4a1d-b6de-e347cd1f84c7
...
# ╔═╡ 3fafe9e4-d65b-43a6-b58b-1ebe3e18a90a
plot_vec(approx_lsolve(20), title = "Восстановленное изображение, 20 сингулярных чисел", topmargin = 20Plots.px)

# ╔═╡ f84a1358-ff46-4741-8ad9-a6a90927635f
md" Настоящее изображение, вероятно, не похоже на белый шум и содержит большие равномерно окрашенные участки. 
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "4cfd5d5d217625fd00f74917f1b2d272cf9c24f2"
